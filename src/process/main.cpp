...
int main( int argc, char *argv[] )
{
  ...
  QgsApplication::setOrganizationName( u"QUICKGIS4_0"_s );
  QgsApplication::setOrganizationDomain( u"quickgis.org"_s );
  QgsApplication::setApplicationName( u"QUICKGIS4_0"_s );
